...
$(function() {
    ...
    function getRandomArray(minNum, maxNum) { //隨機產生不重覆的n個數字
        var rdm = 0; //暫存的亂數
        var end = false;
        do {
